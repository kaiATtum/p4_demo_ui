...
plot(temp,'r-','DisplayName','MG 1: exchange price'); hold on;
plot(temp2,'b-','DisplayName','MG 2: exchange price'); hold on;
plot(temp3,'y-','DisplayName','MG 3: exchange price'); hold on;
%ylim([84 115]);
xlabel('market period');
